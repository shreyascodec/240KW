...
import { CheckCircle, Clock, DollarSign, AlertCircle, HelpCircle, FileText, MessageCircle, Settings } from 'lucide-react'

function DesignSubmissionSuccess() {
  const navigate = useNavigate()

  const nextSteps = [
    {
      title: 'Design Received',
      description: 'Your design details have been successfully received and validated.',
      status: 'completed',
      icon: CheckCircle,
      color: 'green'
    },
    {
      ...
      description: 'Our simulation team is running the required simulations and preparing insights for your Design Verification.',
      status: 'in-progress',
      icon: Settings,
      color: 'blue'
    },
    {
      ...
      description: 'Engineers are analyzing simulation data and preparing detailed design verification reports and insights.',
      status: 'pending',
      icon: FileText,
      color: 'gray'
    },
    {
      ...
      description: 'You\'ll receive a notification once your Design Verification report is ready.',
      status: 'pending',
      icon: CheckCircle,
      color: 'gray'
    },
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <p className="text-lg text-gray-600">Your design is now in expert hands</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600">
            Your design details have been forwarded to our <span className="font-semibold text-blue-600">Simulation Team</span>. They will now run the required simulations and prepare insights for your <span className="font-semibold">Design Verification</span>.
          </p>
        </motion.div>
...
export default DesignSubmissionSuccess
